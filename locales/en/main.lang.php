...
L10n::$locales['Question and answer must be given.'] = '';
...
L10n::$locales['Are you sure you want to delete the selected questions (%s)?'] = '';
L10n::$locales['Are you sure you want to delete all the questions (%s)?'] = '';
L10n::$locales['At least one question must remain!'] = '';
