...
class Uninstall
{
    ...
    public static function process(): bool
    {
        ...
        // Database table name
        $table_main = AccessibleCaptcha::CAPTCHA_TABLE_NAME;
        $table_hash = AccessibleCaptcha::CAPTCHA_HASH_TABLE_NAME;
        ...
        $user_actions = [
            ...
            // Table (database)
            'tables' => [
                ['empty', $table_hash],      // Empty table
                ['empty', $table_main],      // Empty table
                ['delete', $table_hash],     // Delete table
                ['delete', $table_main],     // Delete table
            ],
